...
wget -O subspace-node https://github.com/subspace/subspace/releases/download/gemini-3h-2024-oct-10/subspace-node-ubuntu-x86_64-skylake-gemini-3h-2024-oct-10
wget -O subspace-farmer https://github.com/subspace/subspace/releases/download/gemini-3h-2024-oct-10/subspace-farmer-ubuntu-x86_64-skylake-gemini-3h-2024-oct-10
